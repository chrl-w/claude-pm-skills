...
|-------|-------------------|-----------------|
| **release-notes** | Writing up a release, changelog, or "what shipped" update | Release notes format, GitHub repo configuration, Jira cross-referencing workflow, Notion publishing steps |
